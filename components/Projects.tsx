...
const Projects: React.FC = () => {
  ...
  const isCurrentFocus = (id: string) =>
    id === "connect-s" || id === "clinical-prediction";
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-12">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-4">
          <div>
            ...
            <p className="text-slate-400 max-w-xl">
              A selection of my recent full-stack applications and research
              projects demonstrating technical depth and design quality.
            </p>
          </div>
          <a
            href="https://github.com/Anthony-Pius-1729"
            target="_blank"
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          {PROJECTS.map((project) => (
            <div
              key={project.id}
              className={`group glass-card rounded-[2.5rem] overflow-hidden flex flex-col h-full border transition-all duration-500 hover:shadow-2xl ${
              ...
              >
                ...
                <div className="absolute bottom-6 left-6 right-6 flex justify-between items-end">
                  <div className="flex flex-col gap-2">
                    <span
                      className={`w-fit px-3 py-1 rounded-lg text-[10px] font-black uppercase tracking-[0.2em] bg-${project.color}-600/90 text-white backdrop-blur-md`}
                    >
                      {project.subtitle}
                    </span>
                  </div>
